...
def sieve_without_eratosthenes(i):
    """ Поиск i-го простого числа, без использования «Решета Эратосфена» """
...
def sieve_eratosthenes(i):
    """ Поиск i-го простого числа, с использованием «Решета Эратосфена» """
...
def prime_counting_function(i):
    ...
    и основана на теореме о распределении простых чисел.
